...
import { createProgressTracker, } from '../../services/progressTracker.js';
describe('ProgressTracker', () => {
    ...
    describe('setTotalItems', () => {
        ...
        it('should throw if new total is less than completed', () => {
            ...
            tracker.incrementProgress();
            tracker.incrementProgress();
            expect(() => tracker.setTotalItems(2)).toThrow('totalItems cannot be less than completedItems');
        });
    });
});
