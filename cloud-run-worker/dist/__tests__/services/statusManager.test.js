...
describe('statusManager', () => {
    ...
    describe('Error Handling - handleSupabaseError()', () => {
        ...
        it('should throw descriptive error for PGRST205 (schema cache issue)', async () => {
            ...
            await expect(statusManager.initStatus('test-upload-id', 'user-123')).rejects.toThrow(/Supabase schema cache error: Table 'processing_status' not found in cache/);
        });
        /**
        ...
        it('should throw descriptive error for PGRST116 (no rows returned)', async () => {
            ...
            await expect(statusManager.initStatus('test-upload-id', 'user-123')).rejects.toThrow(/No rows returned for upload_id: test-upload-id/);
        });
        /**
        ...
        it('should throw descriptive error for 42501 (RLS violation)', async () => {
            ...
            await expect(statusManager.initStatus('test-upload-id', 'user-123')).rejects.toThrow(/Permission denied: Row-level security policy violation/);
        });
        /**
        ...
        it('should throw generic error for unknown error codes', async () => {
            ...
            await expect(statusManager.initStatus('test-upload-id', 'user-123')).rejects.toThrow(/Supabase initStatus failed: Something went wrong/);
        });
    });
...
//# sourceMappingURL=statusManager.test.js.map