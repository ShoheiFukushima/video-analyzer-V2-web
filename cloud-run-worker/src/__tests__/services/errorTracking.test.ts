...
import { logCriticalError, logWarning, ErrorContext } from '../../services/errorTracking.js';
...
describe('Error Tracking Service', () => {
  ...
  let consoleWarnMock: jest.MockedFunction<typeof console.warn>;
  ...
  beforeEach(() => {
    ...
    // Create mocks
    consoleErrorMock = jest.fn() as jest.MockedFunction<typeof console.error>;
    consoleWarnMock = jest.fn() as jest.MockedFunction<typeof console.warn>;
  ...
  describe('logCriticalError', () => {
    describe('with Error object', () => {
      it('should log structured JSON with error details', () => {
        ...
        const loggedJson = firstCall[0] as string;
      ...
      it('should include error stack trace', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_456' };

        logCriticalError(testError, context);

        const loggedJson = consoleErrorMock.mock.calls[0][0] as string;
        const parsed = JSON.parse(loggedJson);
    ...
    describe('with unknown error (non-Error object)', () => {
      it('should handle string errors', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_string' };
      ...
      it('should handle number errors', () => {
        ...
        const context: ErrorContext = { operation: 'http-request' };
      ...
      it('should handle object errors', () => {
        ...
        const context: ErrorContext = { stage: 'network' };
      ...
      it('should handle null and undefined errors', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_null' };

        // Test null error
        logCriticalError(null, context);
        let loggedJson = consoleErrorMock.mock.calls[0][0] as string;
        ...
        loggedJson = consoleErrorMock.mock.calls[0][0] as string;
    ...
    describe('development mode behavior', () => {
      it('should log human-readable format in development mode', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_dev' };
        ...
        expect(consoleErrorMock).toHaveBeenNthCalledWith(
          4,
          'Stack:',
          expect.stringContaining('Dev mode error')
        );
      });
      ...
      it('should log human-readable format when NODE_ENV is not set', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_noenv' };
      ...
      it('should skip human-readable logs in production mode', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_prod' };
    ...
    describe('Cloud Monitoring compatibility', () => {
      ...
      it('should use ISO 8601 timestamp format', () => {
        ...
        const context: ErrorContext = { uploadId: 'upload_time' };
  ...
  describe('logWarning', () => {
    it('should log structured warning with context', () => {
      ...
      // Get the first call argument (structured JSON)
      const loggedJson = consoleWarnMock.mock.calls[0][0] as string;
      const parsed = JSON.parse(loggedJson);
    ...
    it('should log human-readable format in development mode', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_dev_warn' };
    ...
    it('should skip human-readable logs in production mode', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_prod_warn' };
    ...
    it('should use ISO 8601 timestamp format', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_warn_time' };
    ...
    it('should handle special characters in message', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_special' };
  ...
  describe('Edge cases and error handling', () => {
    it('should handle circular references gracefully in Error objects', () => {
      ...
      (testError as any).circular = testError;
      const context: ErrorContext = { uploadId: 'upload_circular' };
    ...
    it('should handle very long error messages', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_long' };
    ...
    it('should handle empty error message', () => {
      ...
      const context: ErrorContext = { uploadId: 'upload_empty' };
    ...
    it('should handle empty warning message', () => {
      const message = '';
      const context: ErrorContext = { uploadId: 'upload_empty_warn' };
